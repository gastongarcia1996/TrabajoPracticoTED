...
namespace TrabajoPracticoTED {
    ...
    public partial class DataSet1 : global::System.Data.DataSet {
        ...
        public partial class UsuariosDataTable : global::System.Data.TypedTableBase<UsuariosRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public UsuariosRow FindByidnombre(int id, string nombre) {
...
namespace TrabajoPracticoTED.DataSet1TableAdapters {
    ...
    public partial class UsuariosTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Usuarios] WHERE (([id] = @Original_id) AND ([nombre] = @Origin" +
                "al_nombre) AND ([contraseña] = @Original_contraseña))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Usuarios] ([nombre], [contraseña]) VALUES (@nombre, @contraseñ" +
                "a);\r\nSELECT id, nombre, contraseña FROM Usuarios WHERE (id = SCOPE_IDENTITY()) A" +
                "ND (nombre = @nombre)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Usuarios] SET [nombre] = @nombre, [contraseña] = @contraseña WHERE (([id] = @Original_id) AND ([nombre] = @Original_nombre) AND ([contraseña] = @Original_contraseña));
SELECT id, nombre, contraseña FROM Usuarios WHERE (id = @id) AND (nombre = @nombre)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::TrabajoPracticoTED.Properties.Settings.Default.UsuariosConnectionString;
        }
        ...
        public virtual int Update(string nombre, string contraseña, int Original_id, string Original_nombre, string Original_contraseña, int id) {
            if ((nombre == null)) {
                throw new global::System.ArgumentNullException("nombre");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string contraseña, int Original_id, string Original_nombre, string Original_contraseña) {
            return this.Update(Original_nombre, contraseña, Original_id, Original_nombre, Original_contraseña, Original_id);
        }
    }
